Featurelist = React.createClass({
    features:[
        ...
        {icon: "fa fa-search fa-2x", bigtext: "Find more", littletext:"of what you are looking for with Connectme search"}
        ...
        return(
            <div>
                <h2 className=" col-md-11 featurelist hidden-xs">
                    Connect with friends and the world around you on Connectme
                </h2>
                <ul className="ds-btn hidden-xs">{rows}</ul>
            </div>
        )
    }
});